...
class AddCheckboxField():
    ...
    def __init__(self, driver):
        ...
        self.field_value_textbox_xpath = "//*[@id=\"thwepof_field_form\"]/div[1]/div/table[2]/tbody/tr[2]/td[3]/input"
        self.create_field_button_xpath = "//*[@id=\"thwepof_field_form_pp\"]/div/div/div/div/div/footer/div/button[1]/span"

    def create_checkbox_field(self, field_type, field_name, field_title, field_value):
        ...
        self.driver.find_element_by_xpath(self.field_value_textbox_xpath).send_keys(field_value)
